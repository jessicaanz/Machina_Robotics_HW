...
class Metaclass_SensorData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'custom_interfaces.srv.SensorData')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from custom_interfaces.srv import _sensor_data
...
class SensorData(metaclass=Metaclass_SensorData):
    from custom_interfaces.srv._sensor_data import SensorData_Request as Request
    from custom_interfaces.srv._sensor_data import SensorData_Response as Response
